...
#ifndef JUICE_GUIDS_INCLUDE_H_
#define JUICE_GUIDS_INCLUDE_H_

namespace juice {

// GUID: based on the |CPP/7zip/Guid.txt| from the LZMA SDK (http://www.7-zip.org/sdk.html):
// 
